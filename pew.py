...
_PALETTE = (
    (0x00, 0x00, 0x00), # Hex: #000000, RGB: 0, 0, 0
    (0x00, 0xbb, 0x11), # Hex: #00bb11, RGB: 0, 187, 11
    (0xaa, 0x22, 0x00), # Hex: #aa2200, RGB: 170, 34, 0
    (0xff, 0xaa, 0x00), # Hex: #ffaa00, RGB: 255, 170, 0
)
# Hex to decimal: echo $((0xbb))
